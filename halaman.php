...
<div class="container">
    ...
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/js/bootstrap.bundle.min.js" integrity="sha384-qNKT17vqG4b9ZKZ82FGQW6PQzBP6lH+XDfAQXl6GUkjCp0MhJE1JmWjzLFGJ813Q7/uX4YDsxCtX/" crossorigin="anonymous"></script>
        ...
        searchBtn.addEventListener('click', () => {
            ...
            if (searchTerm) {
                searchResults.innerHTML = `
                    ...
                    <ul class="list-group">
                        <li class="list-group-item">Refila</li>
                    </ul>
                `;
            } else {
